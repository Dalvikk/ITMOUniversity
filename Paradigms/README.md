...
4. [Домашнее задание 14. Разбор выражений на Prolog](#домашнее-задание-14-разбор-выражений-на-prolog)  
5. [Домашнее задание 13. Деревья поиска на Prolog](#домашнее-задание-13-деревья-поиска-на-prolog)  
6. [Домашнее задание 12. Простые числа на Prolog](#домашнее-задание-12-простые-числа-на-prolog)  
7. [Домашнее задание 11. Комбинаторные парсеры](#домашнее-задание-11-комбинаторные-парсеры)  
8. [Домашнее задание 10. Объектные выражения на Clojure](#домашнее-задание-10-объектные-выражения-на-clojure)  
9. [Домашнее задание 9. Функциональные выражения на Clojure](#домашнее-задание-9-функциональные-выражения-на-clojure)  
10. [Домашнее задание 8. Линейная алгебра на Clojure](#домашнее-задание-8-линейная-алгебра-на-clojure)  
11. [Домашнее задание 7. Обработка ошибок на JavaScript](#домашнее-задание-7-обработка-ошибок-на-javascript)  
12. [Домашнее задание 6. Объектные выражения на JavaScript](#домашнее-задание-6-объектные-выражения-на-javascript)  
13. [Домашнее задание 5. Функциональные выражения на JavaScript](#домашнее-задание-5-функциональные-выражения-на-javascript)  
14. [Домашнее задание 4. Вычисление в различных типах](#домашнее-задание-4-вычисление-в-различных-типах)  
15. [Домашнее задание 3. Очереди](#домашнее-задание-3-очереди)  
16. [Домашнее задание 2. Очередь на массиве](#домашнее-задание-2-очередь-на-массиве)  
17. [Домашнее задание 1. Бинарный поиск](#домашнее-задание-1-бинарный-поиск)  
...
[Исходный код тестов](./tests/src/clojure/cljtest/parsing/ParserTest.java)  
Запускать c указанием модификации (`ImplIff`) и сложности (`easy` или `hard`).
