...
public class MultiTests extends VariablesTests {
    private static final Random RANDOM = new Random(894385743857439L);
    ...
    protected void randomMulti(final boolean testMulti, final String... functions) {
        final Supplier<AbstractExpression> generator = () -> random(vx, vy, vz, c(RANDOM.nextInt(10)), c(RANDOM.nextInt(10)));
        for (int i = 1; i < 10; i++) {
